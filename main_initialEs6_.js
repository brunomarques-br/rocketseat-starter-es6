...
/* 
    ...
    ** AULA #9 ** - Object Short Syntax (Sintaxe curta de objeto) utilizando Es6
...
// Quando o nome da propriedade é o mesmo nome da variável, não precisa repetir o nome e utilizar os dois pontos (:)
const usuario = {
    nome,
    idade,
    emrpesa: 'BS.io'
